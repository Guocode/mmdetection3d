...
def get_kitti_info_path(idx,
    ...
    prefix = Path(prefix)
    if training:
        file_path = Path('training').joinpath(info_type,img_idx_str).as_posix()#Path('training') / info_type / img_idx_str
    else:
        file_path = Path('testing').joinpath(info_type,img_idx_str).as_posix()#Path('testing') / info_type / img_idx_str
