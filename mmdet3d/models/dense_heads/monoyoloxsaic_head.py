...
class MonoYOLOXSAICHead(BaseDenseHead, BBoxTestMixin):
...
if __name__ == '__main__':
    ...
    def tt_yolox_head_loss():
        ...
        train_cfg = mmcv.Config(
            dict(
                assigner=dict(
                    ...
                    iou_weight=3.0,
                    cls_weight=1.0)))
        self = MonoYOLOXSAICHead(
            num_classes=3, in_channels=1, use_depthwise=False, train_cfg=train_cfg)
        ...
        # random inputs
        self = MonoYOLOXSAICHead(
            num_classes=3, in_channels=1, use_depthwise=True, train_cfg=train_cfg)
