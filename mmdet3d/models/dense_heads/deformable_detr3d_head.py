...
from mmdet.core import multi_apply, reduce_mean, bbox_cxcywh_to_xyxy
...
class DeformableDETR3DHead(DETRHead):
    ...
    def loss_single(self,
        ...
        print(cls_scores[bbox_weights[:,0]==1])
        ...
        print(bboxes[bbox_weights[:,0]==1][0])
        print(bboxes_gt[bbox_weights[:,0]==1][0])
